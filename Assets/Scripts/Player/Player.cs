...
[RequireComponent(typeof(SortingGroup))] //it allows Unity to render a game object as a whole based on its descendants and their corresponding renderers in their respective order by sorting groups and sorting layers
[RequireComponent(typeof(SpriteRenderer))]
[RequireComponent(typeof(Animator))]
[RequireComponent(typeof(BoxCollider2D))] //player won't go off the map through walls
[RequireComponent(typeof(PolygonCollider2D))] //player will interact with things like enemy shots
[RequireComponent(typeof(Rigidbody2D))] //player will interact with 2D physics
